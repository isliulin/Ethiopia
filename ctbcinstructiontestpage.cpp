...
ROMDATA g_PicRom_InstructionTestTBC[] =
{
    /*string                       font                            rc                  foreground color              background color                control type                   ID           */
    {QSTR("MC1MSR1 Disable TBC"),   D_FONT(5),         QRect( 70,  30, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_00   },
    {QSTR("MC1MSR2 Disable TBC"),   D_FONT(5),         QRect( 70, 100, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_01   },
    {QSTR("MC2MSR1 Disable TBC"),   D_FONT(5),         QRect( 70, 170, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_02   },
    {QSTR("MC2MSR2 Disable TBC"),   D_FONT(5),         QRect( 70, 240, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_03   },
    {QSTR("MC1ACU Disable TBC"),    D_FONT(5),          QRect(70,  310, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_04   },
    {QSTR("MC2ACU Disable TBC"),    D_FONT(5),          QRect(70,  380, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_05   },
    {QSTR("MC1ACU Reset TBC"),     D_FONT(5),          QRect(260, 30, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_06   },
    {QSTR("MC2ACU Reset TBC"),     D_FONT(5),          QRect(260, 100, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_07    },
    {QSTR("MC1 BCC Disable TBC"),    D_FONT(5),          QRect(260, 170, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_08    },
    {QSTR("MC2 BCC Disable TBC"),    D_FONT(5),          QRect(260, 240, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_09    },
    {QSTR("MC1 BCC Reset TBC"),      D_FONT(5),          QRect(260, 310, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_10    },
    {QSTR("MC2 BCC Reset TBC"),      D_FONT(5),          QRect(260, 380, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_11    },
    {QSTR("MC1 TCU Reset TBC"),       D_FONT(5),          QRect(450, 30, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_12    },
    {QSTR("MC2 TCU Reset TBC"),       D_FONT(5),          QRect(450, 100, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_13    },
//    {QSTR("MC1 Friction\n Brake Release TBC"),       D_FONT(5),      QRect(450,  170, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_14    },
//    {QSTR("MC2 Friction\n Brake Release TBC"),       D_FONT(5),      QRect(450,  240, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_15    },
...
//    {QSTR("Factory Test"),       D_FONT(7),          QRect(450, 380, 120, 40),       Qt::black,                   Qt::yellow,                CONTROL_BUTTON,         ID_PICIT_TEST_BUTTON_17    },
    {QSTR("upgray.png"),       D_FONT(5),          QRect(590, 390, 40, 30),       Qt::black,                   Qt::yellow,                CONTROL_BMPBUTTON,         ID_PICIT_TEST_BUTTON_14    },


    D_LAYER2_NAVIGATION_BAR_MAINTAIN

};
int g_InstructionTestTBCRomLen = sizeof(g_PicRom_InstructionTestTBC)/sizeof(ROMDATA);
...
BEGIN_MESSAGE_MAP(CTBCInstructionTestpage,CPage)
        ON_UPDATE_PAGE()
...
CTBCInstructionTestpage::CTBCInstructionTestpage()
{
    m_counter = 0;
    m_counter2 = 0;
    m_counter3 = 0;
...
void CTBCInstructionTestpage::OnInitPage()
{
    for(unsigned int i = 0; i < sizeof(nBtnIDArrayTBC)/sizeof(int); i++)
    {
        ((CButton*)GetDlgItem(nBtnIDArrayTBC[i]))->m_bAutoUpState = false;
    }

}

void CTBCInstructionTestpage::OnUpdatePage()
{
...
//qDebug()<<TEST_Mc2TFCUReset_BOOL<<"6";
    ...
    {
        ((CBitmapButton *)GetDlgItem(ID_PICIT_TEST_BUTTON_14))->ChangeButtonState( LBUTTON_UP );
        ((CBitmapButton *)GetDlgItem(ID_PICIT_TEST_BUTTON_14))->SetCtrlText("up.png");

    }else
    {
        ((CBitmapButton *)GetDlgItem(ID_PICIT_TEST_BUTTON_14))->ChangeButtonState( LBUTTON_UP );
        ((CBitmapButton *)GetDlgItem(ID_PICIT_TEST_BUTTON_14))->SetCtrlText("upgray.png");
    ...
    if(m_btnID == 7||m_btndown)
    {
        ...
        if(m_counter == 6)
        {
            ...
            TEST_Mc1ACUReset_BOOL_TBC = false;
        }
    }
    ...
    if(m_btnID == 8||m_btndown2)
    {
        ...
        if(m_counter2 == 6)
        {
            ...
            TEST_Mc2ACUReset_BOOL_TBC = false;
        }
    }
    if(m_btnID == 11||m_btndown3)
    {
        ...
        if(m_counter3 == 6)
        {
            ...
            TEST_Mc1BCCReset_BOOL_TBC = false;
        }
    }
    ...
    if(m_btnID == 12||m_btndown4)
    {
        ...
        if(m_counter4 == 6)
        {
            ...
            TEST_Mc2BCCReset_BOOL_TBC = false;
        }
    }
    if(m_btnID == 13||m_btndown5)
    {
        ...
        if(m_counter5 == 6)
        {
            ...
            TEST_Mc1TCUReset_BOOL_TBC = false;
        }
    }
    ...
    if(m_btnID == 14||m_btndown6)
    {
        ...
        if(m_counter6 == 6)
        {
            ...
            TEST_Mc2TCUReset_BOOL_TBC = false;
        }
    }
//    if(m_btndown)
//    {
...
void CTBCInstructionTestpage::OnCommonQuitButtonDown()
{
    ChangePage(PAGE_ROM_INDEX_MAIN);
}

bool CTBCInstructionTestpage::SetButtonDown(int nID)
{
    CButton* pButton = NULL;
    int buttonState;
    for(unsigned int i = 0; i <  sizeof(nBtnIDArrayTBC)/sizeof(int); i++)
    {
        pButton = (CButton *)GetDlgItem(nBtnIDArrayTBC[i]);
        if(nBtnIDArrayTBC[i] == nID) {
...
bool CTBCInstructionTestpage::SetButtonUp(int nID)
{
...
void CTBCInstructionTestpage::OnTestButton00Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_00))
    {
    TEST_Mc1MSR1Disable_BOOL_TBC = !TEST_Mc1MSR1Disable_BOOL_TBC;}
}

void CTBCInstructionTestpage::OnTestButton01Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_01))
        TEST_Mc1MSR2Disable_BOOL_TBC = !TEST_Mc1MSR2Disable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton02Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_02))
        TEST_Mc2MSR1Disable_BOOL_TBC = !TEST_Mc2MSR1Disable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton03Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_03))
        TEST_Mc2MSR2Disable_BOOL_TBC = !TEST_Mc2MSR2Disable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton04Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_04))
        TEST_Mc1ACUDisable_BOOL_TBC = !TEST_Mc1ACUDisable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton05Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_05))
        TEST_Mc2ACUDisable_BOOL_TBC = !TEST_Mc2ACUDisable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton06Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_06))
    {m_btnID = 7;
         m_btndown = true;
         TEST_Mc1ACUReset_BOOL_TBC = !TEST_Mc1ACUReset_BOOL_TBC;}
}

void CTBCInstructionTestpage::OnTestButton07Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_07))
    { m_btnID = 8;
            m_btndown2 = true;
            TEST_Mc2ACUReset_BOOL_TBC = !TEST_Mc2ACUReset_BOOL_TBC;}
}

void CTBCInstructionTestpage::OnTestButton08Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_08))
        TEST_Mc1BCCDisable_BOOL_TBC = !TEST_Mc1BCCDisable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton09Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_09))
        TEST_Mc2BCCDisable_BOOL_TBC = !TEST_Mc2BCCDisable_BOOL_TBC;
}

void CTBCInstructionTestpage::OnTestButton10Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_10))
    {m_btnID = 11;
            m_btndown3 = true;
            TEST_Mc1BCCReset_BOOL_TBC = !TEST_Mc1BCCReset_BOOL_TBC;}
}

void CTBCInstructionTestpage::OnTestButton11Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_11))
    {m_btnID = 12;
            m_btndown4 = true;
            TEST_Mc2BCCReset_BOOL_TBC = !TEST_Mc2BCCReset_BOOL_TBC;}
}

void CTBCInstructionTestpage::OnTestButton12Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_12))
    {m_btnID = 13;
            m_btndown5 = true;
            TEST_Mc1TCUReset_BOOL_TBC = !TEST_Mc1TCUReset_BOOL_TBC;}
}

void CTBCInstructionTestpage::OnTestButton13Down()
{
    if(SetButtonDown(ID_PICIT_TEST_BUTTON_13))
    { m_btnID = 14;
            m_btndown6 = true;
            TEST_Mc2TCUReset_BOOL_TBC = !TEST_Mc2TCUReset_BOOL_TBC;}
}

//void CTBCInstructionTestpage::OnTestButton16Down()
//{
...
//}
//void CTBCInstructionTestpage::OnTestButton17Down()
//{
//    if(SetButtonDown(ID_PICIT_TEST_BUTTON_17))
//        TEST_Factory_BOOL = !TEST_Factory_BOOL;
//}
void CTBCInstructionTestpage::OnTestButton14Down()
{
    if(MAIN_TRAINCOUPLED_BOOL&&MAIN_TRAIN_COUPLED_MS_BOOL)
    {
...
//void CTBCInstructionTestpage::OnTestButton15Down()
//{
//    if(SetButtonDown(ID_PICIT_TEST_BUTTON_15))
//        TEST_Mc2FrictionBrakeRelease_BOOL = !TEST_Mc2FrictionBrakeRelease_BOOL;
//}
//void CTBCInstructionTestpage::OnTestButton18Down()
//{
//   // if(SetButtonDown(ID_PICIT_TEST_BUTTON_18))
//     //   InstructionTest19_Bool = !InstructionTest19_Bool;
//}
//void CTBCInstructionTestpage::OnTestButton19Down()
//{
