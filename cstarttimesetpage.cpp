...
ROMDATA g_PicRom_StartTimeSet[] =
{
    ...
    {QSTR("Start Time Setting"),  D_FONT(13),      QRect(  0,  0, 640,  60),       Qt::black,                   Qt::yellow,                 CONTROL_LABEL,        ID_IGNORE                },
    ...
    {QSTR("Clear"),           D_COMMON_TITLE_FONT,      QRect(450,  250, 100, 50),      Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICSTS_BUTTON_CLEAR    },

    {QSTR("Set"),             D_COMMON_TITLE_FONT,      QRect( 70,  380, 120, 50),      Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICSTS_BUTTON_SET      },
    {QSTR("Quit"),            D_COMMON_TITLE_FONT,      QRect(260,  380, 120, 50),      Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       IDBTN_PICSTS_QUIT         },
    {QSTR("Default"),         D_COMMON_TITLE_FONT,      QRect(450,  380, 120, 50),      Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       IDBTN_PICSTS_DEFAULT      },
...
void CStartTimeSetPage::OnDefaultButtonUp()
{
    ...
    if (E_INVOKE_HISTORY == g_invoke_type)
    {
        ...
        ((CHistoryFaultListPage *)pPage)->SetStartTime(QSTR("ALL"));
    }
    else if (E_INVOKE_CURRENT == g_invoke_type)
    {
        ChangePage(PAGE_ROM_INDEX_CURRENTFAULTLIST);
        CPage* pPage = g_PageVec[CGlobal::m_nCurPageIndex];
        ((CCurrentFaultListPage *)pPage)->SetStartTime(QSTR("ALL"));
    }
}
