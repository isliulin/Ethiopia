...
ROMDATA g_PicRom_DriverCodeList[] =
{
    ...
    {QSTR("Driver Code List"),     D_FONT(13), QRect(0,0,640,60),                          Qt::black,                  Qt::yellow,                 CONTROL_LABEL,            ID_PICDCL_LABEL_TITLE     },
    //label
    ...
    {QSTR("Delete"),    D_FONT_BOLD(10),      QRect(320, 365,  85,  50),                 Qt::yellow,                 Qt::black,                  CONTROL_BUTTON,           IDBTN_PICDCL_DELETE        },
    {QSTR("Quit"),    D_FONT_BOLD(10),      QRect(430, 365,  85,  50),                 Qt::yellow,                 Qt::black,                  CONTROL_BUTTON,           IDBTN_PICDCL_QUIT        },
