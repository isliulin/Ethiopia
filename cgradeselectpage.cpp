...
ROMDATA g_PicRom_GradeSelect[] =
{
    ...
    {QSTR("Grade Selection"),      D_FONT(13),           QRect(  0,  0,640, 60),        Qt::black,                   Qt::yellow,                 CONTROL_LABEL,        ID_IGNORE                },
    {QSTR("ALL"),         D_COMMON_TITLE_FONT,  QRect(220,120,200, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICGS_BUTTON_GRADEALL },
