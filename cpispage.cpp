...
ROMDATA g_PicRom_Pis[] =
{
    ...
    {QSTR("Line Select"),      D_COMMON_TITLE_FONT,      QRect(80, 100, 170, 30),    Qt::yellow,                     Qt::black,                     CONTROL_LABEL,         ID_PICPIS_LABEL_LINECH      },
    {QSTR("up/down"),     D_COMMON_TITLE_FONT,      QRect(80, 160-10, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_UPORDOWN      },
    {QSTR("Starting station"),        D_COMMON_TITLE_FONT,      QRect(80, 210-10, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_STARTSTATION  },
    {QSTR("Terminal station"),        D_COMMON_TITLE_FONT,      QRect(80, 260-10, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_ENDSTATION    },
    //{QSTR("当前站"),        D_COMMON_TITLE_FONT,      QRect(80, 310, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_CURRENTSTATION},
    {QSTR("TCMS OR PIS"),     D_COMMON_TITLE_FONT,      QRect(80, 360-10, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_TCMSORTC      },

    {"EW",                 D_COMMON_TITLE_FONT,       QRect(385,100,  30, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_LINENO   },
    {QSTR("up"),         D_COMMON_TITLE_FONT,       QRect(320,160-10, 160, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_UPDOWN   },
    {"Stationa",          D_COMMON_TITLE_FONT,       QRect(320,210-10, 160, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_STARTSTATION   },
    {"Stationb",          D_COMMON_TITLE_FONT,       QRect(320,260-10, 160, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_ENDSTATION     },
    {"Stationc",          D_COMMON_TITLE_FONT,       QRect(320,310-10, 160, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_CURRENTSTATION     },

    //{"Stationc",          D_COMMON_TITLE_FONT,       QRect(320,310, 160, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_CURRENTSTATION },
    {QSTR("Auto"),              D_COMMON_TITLE_FONT,       QRect(320,360-10, 160, 30),    Qt::yellow,                    Qt::black,                      CONTROL_LABEL,          ID_PICPIS_LABEL_TCMSORTC       },
    {QSTR("Emergency Broadcast"),     D_COMMON_TITLE_FONT,      QRect(80, 410-10, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_EMERGENCY      },
    {QSTR("Current Station"),     D_COMMON_TITLE_FONT,      QRect(80, 310-10, 170, 30),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_CURRENTSTATIONSET      },

    {QSTR("Station Set\nConfirm"),     D_COMMON_TITLE_FONT,      QRect(480, 350, 100, 60),    Qt::black,                     Qt::yellow,                     CONTROL_BUTTON,         ID_PICPIS_BUTTON_CONFIRM      },

    // {QSTR("当前站"),              D_DEFAULT_FONT,       QRect(480, 195, 100, 20),    Qt::blue,                    Qt::black,                      CONTROL_LABEL,          LABEL_ID_CURRENT_STATION_CODE       },
    // {QSTR("下一站"),     D_DEFAULT_FONT,      QRect(480, 220, 100, 20),    Qt::blue,                     Qt::black,                     CONTROL_LABEL,         LABEL_ID_NEXT_STATION_CODE      },
    // {QSTR("预发车"),     D_DEFAULT_FONT,      QRect(480, 245, 100, 20),    Qt::blue,                     Qt::gray,                     CONTROL_LABEL,         LABEL_ID_TRAIN_PRERUN      },
    // {QSTR("发车"),     D_DEFAULT_FONT,      QRect(480, 270, 100, 20),    Qt::blue,                     Qt::gray,                     CONTROL_LABEL,         LABEL_ID_TRAIN_RUN      },
    // {QSTR("预到站"),     D_DEFAULT_FONT,      QRect(480, 295, 100, 20),    Qt::blue,                     Qt::gray,                     CONTROL_LABEL,         LABEL_ID_TRAIN_PREARRIVE      },
    // {QSTR("到站"),     D_DEFAULT_FONT,      QRect(480, 320, 100, 20),    Qt::blue,                     Qt::gray,                     CONTROL_LABEL,         LABEL_ID_TRAIN_ARRIVE      },
...
BEGIN_MESSAGE_MAP(CPisPage,CPage)
        ...
        ON_LBUTTONDOWN(ID_PICPIS_EMERGENCY, OneEmergencyBroadcastDown)
        ...
        ON_LBUTTONUP(ID_PICPIS_EMERGENCY, OneEmergencyBroadcastUp)
        ...
        ON_LBUTTONDOWN(ID_PICPIS_BUTTON_CONFIRM, OnStationSetConfirmButtonDown)
        ON_LBUTTONUP(ID_PICPIS_BUTTON_CONFIRM, OnStationSetConfirmButtonUp)

        ON_LBUTTONDOWN(ID_PICPIS_BUTTON_CURRENTSTATIONSET, OnCurrentStationSetButtonDown)
        ON_LBUTTONUP(ID_PICPIS_BUTTON_CURRENTSTATIONSET, OnCurrentStationSetButtonUp)
...
//    }
   ...
   // ((CLabel*)GetDlgItem(ID_PICPIS_LABEL_LINENO))->SetCtrlText(QString::number(currentLineNo));
    ((CLabel*)GetDlgItem(ID_PICPIS_LABEL_LINENO))->SetCtrlText("EW");
...
void CPisPage::OnUpdatePage()
{
    ...
    GetDlgItem(ID_PICPIS_LABEL_STARTSTATION)->SetCtrlText(stationNameList.at((int)g_StationSet_DepartureStation_Uchar-1));
    GetDlgItem(ID_PICPIS_LABEL_CURRENTSTATION)->SetCtrlText(stationNameList.at((int)g_StationSet_CurrentStation_Uchar-1));
...
//    }
    ...
    else if(currentLineNo==MAX_LINENO )
    {
        ((CBitmapButton *)GetDlgItem(ID_PICPIS_BUTTON_UP))->SetCtrlText("upgray.png");
        ((CLabel*)GetDlgItem(ID_PICPIS_LABEL_LINENO))->SetBorderColor(Qt::yellow);
        ((CLabel*)GetDlgItem(ID_PICPIS_LABEL_LINENO))->SetCtrlText("NS");
    }
...
void CPisPage::OnUpDownBtnUp()
{
    ...
    StationSettedFlagtemp_Bool = true;
    if(StationSet_UpOrDown_Bool)
    {
        ((CLabel*)GetDlgItem(ID_PICPIS_LABEL_UPDOWN))->SetCtrlText(QSTR("UP"));
...
void CPisPage::OneEmergencyBroadcastDown()
{
    ((CButton*)GetDlgItem(ID_PICPIS_EMERGENCY))->ChangeButtonState(LBUTTON_DOWN);

}

void CPisPage::OneEmergencyBroadcastUp()
{
    ((CButton*)GetDlgItem(ID_PICPIS_EMERGENCY))->ChangeButtonState(LBUTTON_UP);
    ChangePage(PAGE_ROM_INDEX_EMERGENCYBROADCAST);

}
void CPisPage::OnStationSetConfirmButtonDown()
{

   ((CButton*)GetDlgItem(ID_PICPIS_BUTTON_CONFIRM))->ChangeButtonState(LBUTTON_DOWN);

}
void CPisPage::OnStationSetConfirmButtonUp()
{
   StationSettedFlag_Bool = true;
   ((CButton*)GetDlgItem(ID_PICPIS_BUTTON_CONFIRM))->ChangeButtonState(LBUTTON_UP);

}
void CPisPage::OnCurrentStationSetButtonDown()
{

   ((CButton*)GetDlgItem(ID_PICPIS_BUTTON_CURRENTSTATIONSET))->ChangeButtonState(LBUTTON_DOWN);

}
void CPisPage::OnCurrentStationSetButtonUp()
{

   ((CButton*)GetDlgItem(ID_PICPIS_BUTTON_CURRENTSTATIONSET))->ChangeButtonState(LBUTTON_UP);
    ChangePage(PAGE_ROM_INDEX_CURRENTSTATIONSET);
}
