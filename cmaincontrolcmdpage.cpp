...
ROMDATA g_PicRom_MainControlCmd[] =
{
    ...
    {QSTR("Auto Sanding\nForbidden"),         D_FONT(7),  QRect(128,100,128, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICMCC_BUTTON_SAND_FORBID   },
    ...
    {QSTR("HMI Fan"),             D_FONT(7),  QRect(384,240,128, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICMCC_BUTTON_HMIFAN   },
    {QSTR("Coupling"),             D_FONT(7),  QRect(384,310,128, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICMCC_BUTTON_COUPLING   },
...
BEGIN_MESSAGE_MAP(CMainControlCmdPage,CPage)
        ...
        ON_LBUTTONDOWN(ID_PICMCC_BUTTON_HMIFAN,OnButtonHMIFan)
        ON_LBUTTONDOWN(ID_PICMCC_BUTTON_SKIPSTATION,OnSkipStationDown)
        ON_LBUTTONDOWN(ID_PICMCC_BUTTON_COUPLING,OnButtonCoupling)
...
void CMainControlCmdPage::OnInitPage()
{
    ...
    int nIDArray[] =
    {
        ...
        ID_PICMCC_BUTTON_HMIFAN,
        ID_PICMCC_BUTTON_COUPLING,
    ...
    if(Main_HMIFan_bool)
    {
        ((CButton *)GetDlgItem(ID_PICMCC_BUTTON_HMIFAN))->ChangeButtonState(LBUTTON_DOWN);
    }
    else
    {
        ((CButton *)GetDlgItem(ID_PICMCC_BUTTON_HMIFAN))->ChangeButtonState(LBUTTON_UP);
    }
    ...
    if(Coupling_Bool)
    {
        ((CButton *)GetDlgItem(ID_PICMCC_BUTTON_COUPLING))->ChangeButtonState(LBUTTON_DOWN);
    }
    else
    {
        ((CButton *)GetDlgItem(ID_PICMCC_BUTTON_COUPLING))->ChangeButtonState(LBUTTON_UP);
    }
...
void CMainControlCmdPage::OnButtonHMIFan()
{
    Main_HMIFan_bool = !Main_HMIFan_bool;
    if(Main_HMIFan_bool)
    {
        ((CButton *)GetDlgItem(ID_PICMCC_BUTTON_HMIFAN))->ChangeButtonState(LBUTTON_DOWN);
    }
...
void CMainControlCmdPage::OnButtonCoupling()
{
    Coupling_Bool = !Coupling_Bool;
    if(Coupling_Bool)
    {
        DispatchMode_Bool =  false;
        WashingMode_Bool =  false;
