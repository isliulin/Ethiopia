...
void SerialThread232::getData1()
{
    ...
    if( isOpen() )
    {
        ...
        cmd[3] = 0x32;// low byte of read start address
        cmd[4] = 0x00;// high byte of read length
        cmd[5] = 0x78;// low byte of read length
...
void SerialThread232::getData2()
{
    ...
    if( isOpen() )
    {
        ...
        cmd[1] = 0x03;// modbus function code
        cmd[2] = 0x00;// high byte of read start address
        cmd[3] = 0xAA;// low byte of read start address
        cmd[4] = 0x00;// high byte of read length
        cmd[5] = 0x76;// low byte of read length
        int len = SendRtuCmdToModBus( cmd, 6 );
        if( len == 8 )
        {
            sendDataCnt++;
...
void SerialThread232::setData()
{
    ...
    if( isOpen() )
    {
        ...
        cmd[3] = 0x00;// low byte of write start address
