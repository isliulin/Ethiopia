...
public:
    ...
    void retranslateUi(QDialog *CConfirmDialog)
    {
        ...
        pushButton_yes->setText(QApplication::translate("CConfirmDialog", "OK", 0, QApplication::UnicodeUTF8));
        pushButton_no->setText(QApplication::translate("CConfirmDialog", "Cancel", 0, QApplication::UnicodeUTF8));
