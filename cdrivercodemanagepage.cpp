...
ROMDATA g_PicRom_DriverCodeManage[] =
{
    ...
    {QSTR("Driver Code Management"),   D_FONT(13),  QRect(0  ,    0, 640, 60),       Qt::black,                    Qt::yellow,                 CONTROL_LABEL,        ID_IGNORE                },

    {"1",                  D_COMMON_TITLE_FONT,  QRect(450,  100,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER1  },
    {"2",                  D_COMMON_TITLE_FONT,  QRect(500,  100,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER2  },
    {"3",                  D_COMMON_TITLE_FONT,  QRect(550,  100,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER3  },
    {"4",                  D_COMMON_TITLE_FONT,  QRect(450,  150,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER4  },
    {"5",                  D_COMMON_TITLE_FONT,  QRect(500,  150,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER5  },
    {"6",                  D_COMMON_TITLE_FONT,  QRect(550,  150,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER6  },
    {"7",                  D_COMMON_TITLE_FONT,  QRect(450,  200,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER7  },
    {"8",                  D_COMMON_TITLE_FONT,  QRect(500,  200,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER8  },
    {"9",                  D_COMMON_TITLE_FONT,  QRect(550,  200,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER9  },
    {"0",                  D_COMMON_TITLE_FONT,  QRect(450,  250,  50, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_NUMBER0  },
    {QSTR("Clear"),                D_COMMON_TITLE_FONT,  QRect(500,  250, 100, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_CLEAR    },
    {"",                         D_FONT(9),            QRect( 60,  260, 200, 50),        Qt::yellow,                  Qt::black,                 CONTROL_LABEL,        ID_PICDCM_LABEL_SUCCESS       },
    {QSTR("Driver Code List"),         D_COMMON_TITLE_FONT,  QRect( 60,  380, 260, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_OK       },
    {QSTR("Quit"),                D_COMMON_TITLE_FONT,  QRect(400,  380, 120, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       IDBTN_PICDCM_QUIT        },
    {QSTR("Add Driver Code(4bits)"),    D_COMMON_TITLE_FONT,   QRect( 20,  110, 230, 50),        Qt::yellow,                  Qt::black,                  CONTROL_LABEL,        ID_IGNORE                 },
    {"",                          D_COMMON_TITLE_FONT,           QRect(260,  110, 110, 50),        Qt::yellow,                  Qt::black,                 CONTROL_EDIT,         ID_PICDCM_EDIT_ADD},
    {QSTR("OK"),                 D_COMMON_TITLE_FONT,  QRect(380,  112,  60, 45),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICDCM_BUTTON_ADD  },
};
...
void CDriverCodeManagePage::OnInitPage()
{
    ...
    GetDlgItem(ID_PICDCM_EDIT_ADD)->SetCtrlText("");
...
void CDriverCodeManagePage::OnAddOKUP()
{
    ...
    strInput = GetDlgItem(ID_PICDCM_EDIT_ADD)->GetCtrlText();
    if(strInput == "")
    {
        CWarningDialog warningDlg;
        warningDlg.SetWarningStr(QSTR("Driver Code is Null!"));
    ...
    else if(strInput.length() != g_loginIDPWDLen)
    {
        CWarningDialog warningDlg;
        warningDlg.setGeometry(m_pDlg->x()+int((m_pDlg->width()-400)/2),m_pDlg->y()+int((m_pDlg->height()-120)/2),400,120);
        warningDlg.SetWarningStr(QSTR("Driver Code Length Error!"));
        warningDlg.exec();
        ((CLabel *)GetDlgItem(ID_PICDCM_LABEL_SUCCESS))->SetCtrlText("");
        return;
    }
    else if( strInput.toUInt()<1 || strInput.toUInt()>8999 )
    {
        CWarningDialog warningDlg;
        warningDlg.setGeometry(m_pDlg->x()+int((m_pDlg->width()-400)/2),m_pDlg->y()+int((m_pDlg->height()-120)/2),400,120);
        warningDlg.SetWarningStr(QSTR("Driver Code is out of range（1～9000）！"));
        warningDlg.exec();
        ((CLabel *)GetDlgItem(ID_PICDCM_LABEL_SUCCESS))->SetCtrlText("");
        return;
    }
    else
    {
        ...
        {
            strInput = QSTR("Driver Code：") + strInput + QSTR("already exists");
            CWarningDialog warningDlg;
            warningDlg.setGeometry(m_pDlg->x()+int((m_pDlg->width()-400)/2),m_pDlg->y()+int((m_pDlg->height()-120)/2),400,120);
        ...
        {
            m_MapDriverCode.insert(strInput,m_DriverIndex);
            m_DriverIndex++;
            strCode = (ConfigIniRead->value("/DriverCode/Code")).toString();
            if(strCode.length() == 0)
            {
            ...
            {
                strCode = strCode + "," +  strInput;
            }

            ConfigIniRead->setValue("/DriverCode/Code",strCode);
            ((CLabel *)GetDlgItem(ID_PICDCM_LABEL_SUCCESS))->SetCtrlText(QSTR("Add successfully"));
        }
    }
    delete ConfigIniRead;
}
void CDriverCodeManagePage::OnDeleteOKUP()
{
    ...
    else
    {
        if(!m_MapDriverCode.contains(strInput))
        {
            ...
            strInput = QSTR("Driver Code") + strInput + QSTR("Not Exists");
            CWarningDialog warningDlg;
            warningDlg.SetWarningStr(strInput);
            warningDlg.setGeometry(m_pDlg->x()+int((m_pDlg->width()-400)/2),m_pDlg->y()+int((m_pDlg->height()-120)/2),400,120);
            warningDlg.exec();
        ...
        else
        {
            ...
            ConfigIniRead->setValue("/DriverCode/Code",strCode);
            ((CLabel *)GetDlgItem(ID_PICDCM_LABEL_SUCCESS))->SetCtrlText(QSTR("Delete successfully"));
        }
    }
    delete ConfigIniRead;
}
