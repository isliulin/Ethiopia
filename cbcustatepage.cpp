...
void CBcuStatePage::OnUpdatePage()
{
 ...
 /* */
    ...
    case 1:
        ...
        ((CLabel*)GetDlgItem(IDLABEL_PICBCU_9_2))->SetCtrlText(QString::number(BCU_LOAD_BYTE)+"%");
        ((CLabel*)GetDlgItem(IDLABEL_PICBCU_10_2))->SetCtrlText(mRound(BCU_LOAD_SENSOR1_BYTE*0.1,1));
        ((CLabel*)GetDlgItem(IDLABEL_PICBCU_11_2))->SetCtrlText(mRound(BCU_LOAD_SENSOR2_BYTE*0.1,1));
