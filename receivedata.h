...
// Changchun company wants to show both current value and pressure value of pressure sensor named AI3
// formula: pressure(bar) = 0.625 * current(mA) - 2.5
#define     PRESSSENSOR_MC1_RIOM_WORD       (receiveData[9] / 10.0f)
#define     PRESSURE_VALUE_MC1_RIOM_WORD    (PRESSSENSOR_MC1_RIOM_WORD * 0.625f - 2.5f)
...
#define SPEEDSIGNAL_MC2_RIOM_WORD                      receiveData[44] + receiveData[45]*256 
    ...
    #define LOADSENSOR1_MC2_RIOM_WORD                      receiveData[34]

    #define LOADSENSOR2_MC2_RIOM_WORD                      receiveData[35]

// added by Deng Ran on January 30th,
// Changchun company wants to show both current value and pressure value of pressure sensor named AI3
// formula: pressure(bar) = 0.625 * current(mA) - 2.5
#define PRESSSENSOR_MC2_RIOM_WORD (receiveData[33] / 10.0f)
#define PRESSURE_VALUE_MC2_RIOM_WORD (PRESSSENSOR_MC2_RIOM_WORD * 0.625f - 2.5f)
...
// changed by Deng Ran on the 11th of June 2015.
...
#define ATC1_TIME1_UINT                                (receiveData[468] + receiveData[469] * 256)
#define ATC1_TIME2_UINT                                (receiveData[470] + receiveData[471] * 256)
#define ATC2_TIME1_UINT                                (receiveData[472] + receiveData[473] * 256)
#define ATC2_TIME2_UINT                                (receiveData[474] + receiveData[475] * 256)
...
#define ZEROLOCKFLAG_MC1_MSR1_BOOL                           receiveData[237-40] &bit6
...
#define ZEROLOCKFLAG_MC1_MSR2_BOOL                           receiveData[255-40] &bit6
...
#define ZEROLOCKFLAG_MC2_MSR1_BOOL                           receiveData[273-40] &bit6
...
#define ZEROLOCKFLAG_MC2_MSR2_BOOL                           receiveData[291-40] &bit6
...
#define MAIN_RESCUE_BOOL                                            receiveData[362] &bit4
...
#define VISION_MC1_PIS_UINT                     receiveData[134]+receiveData[135]*256
#define VISION_MC2_PIS_UINT                     receiveData[136]+receiveData[137]*256
#define VISION_MC1_ACU_BYTE                     receiveData[151]
#define VISION_MC2_ACU_BYTE                     receiveData[173]
...
#define VISION_RIOM1_PWM_BYTE                     receiveData[17]
#define VISION_RIOM1_GWM_BYTE                     receiveData[18]
#define VISION_RIOM2_PWM_BYTE                     receiveData[41]
#define VISION_RIOM2_GWM_BYTE                     receiveData[42]

//2014-5-6 ADD COUPLED DATASTREAM
#define ACU_MC1_OUTPUTVOLTAGE_UINT_TBC                  receiveData[282]+receiveData[283]*256
#define ACU_MC1_OUTPUTCURRENT_UINT_TBC                  receiveData[284]+receiveData[285]*256
...
#define MAIN_BACKUPMODE_BOOL                                     receiveData[368] & bit4
#define MAIN_VCUMS_BOOL                                     receiveData[368] & bit5
#define MAIN_BYPASSWARNING_BOOL                                     receiveData[368] & bit6
...
///14-7-25 add subsystem faults list
//FAULTS
//#define TCU_MC1_MSR1_LINEOVERVOLTAGE                        receiveData[200]&bit0
//#define TCU_MC1_MSR1_CHARGINGFAULT                        receiveData[200]&bit1
//#define TCU_MC1_MSR1_BRA                        receiveData[200]&bit2
//#define TCU_MC1_MSR1_LINEOVERVOLTAGE                        receiveData[200]&bit3
//#define TCU_MC1_MSR1_LINEOVERVOLTAGE                        receiveData[200]&bit4
//#define TCU_MC1_MSR1_LINEOVERVOLTAGE                        receiveData[200]&bit5
//#define TCU_MC1_MSR1_LINEOVERVOLTAGE                        receiveData[200]&bit6
//#define TCU_MC1_MSR1_LINEOVERVOLTAGE                        receiveData[200]&bit7

//2014-9-3 add tbc data
#define ACU_MC1_MODUL_OK_BOOL_TBC                           receiveData[281]&bit0
#define ACU_MC1_MODUL_STOP_BOOL_TBC                           receiveData[281]&bit1
#define BCC_MC1_MODUL_OK_BOOL_TBC                           receiveData[281]&bit2
#define BCC_MC1_MODUL_STOP_BOOL_TBC                           receiveData[281]&bit3
#define ACU_MC2_MODUL_OK_BOOL_TBC                           receiveData[281]&bit4
#define ACU_MC2_MODUL_STOP_BOOL_TBC                           receiveData[281]&bit5
#define BCC_MC2_MODUL_OK_BOOL_TBC                           receiveData[281]&bit6
#define BCC_MC2_MODUL_STOP_BOOL_TBC                          receiveData[281]&bit7

#define BCC_MC1_BATTCURRENT_UINT_TBC                            receiveData[430]+receiveData[431]*256
#define BCC_MC2_BATTCURRENT_UINT_TBC                            receiveData[432]+receiveData[433]*256
#define ACU_MC1_IFAULTREG2_WORD_TBC                                 receiveData[434]+ receiveData[435]*256
#define ACU_MC2_IFAULTREG2_WORD_TBC                                 receiveData[436]+ receiveData[437]*256

#define BCU_IDIAGNOSISREG1_WORD_TBC                             receiveData[400]+ receiveData[401]*256
#define BCU_IDIAGNOSISREG2_WORD_TBC                             receiveData[402]+ receiveData[403]*256
#define BCU_IDIAGNOSISREG3_WORD_TBC                             receiveData[404]+ receiveData[405]*256
#define BCU_IDIAGNOSISREG4_WORD_TBC                             receiveData[406]+ receiveData[407]*256

#define TCU_MC1MSR1_TRCINVERTER1WARNING_BOOL_TBC                receiveData[454]&bit0
#define TCU_MC1MSR1_TRCINVERTER1FAULT_BOOL_TBC                receiveData[454]&bit1
#define TCU_MC1MSR1_TRCINVERTER1WORKING_BOOL_TBC                receiveData[454]&bit2
#define TCU_MC1MSR1_BRAKECHOPPER1WORKING_BOOL_TBC                receiveData[454]&bit3
#define TCU_MC1MSR1_MAINCONTACTOR1CLOSED_BOOL_TBC                receiveData[454]&bit4
#define TCU_MC1MSR1_MOTOR1SLIDE_BOOL_TBC                receiveData[454]&bit5
#define TCU_MC1MSR1_MOTOR1SLIP_BOOL_TBC                receiveData[454]&bit6
#define TCU_MC1MSR1_COOLINGFANOK_BOOL_TBC                receiveData[454]&bit7

#define TCU_MC1MSR2_TRCINVERTER1WARNING_BOOL_TBC                receiveData[455]&bit0
#define TCU_MC1MSR2_TRCINVERTER1FAULT_BOOL_TBC                receiveData[455]&bit1
#define TCU_MC1MSR2_TRCINVERTER1WORKING_BOOL_TBC                receiveData[455]&bit2
#define TCU_MC1MSR2_BRAKECHOPPER1WORKING_BOOL_TBC                receiveData[455]&bit3
#define TCU_MC1MSR2_MAINCONTACTOR1CLOSED_BOOL_TBC                receiveData[455]&bit4
#define TCU_MC1MSR2_MOTOR1SLIDE_BOOL_TBC                receiveData[455]&bit5
#define TCU_MC1MSR2_MOTOR1SLIP_BOOL_TBC                receiveData[455]&bit6
#define TCU_MC1MSR2_COOLINGFANOK_BOOL_TBC                receiveData[455]&bit7

#define TCU_MC2MSR1_TRCINVERTER1WARNING_BOOL_TBC                receiveData[456]&bit0
#define TCU_MC2MSR1_TRCINVERTER1FAULT_BOOL_TBC                receiveData[456]&bit1
#define TCU_MC2MSR1_TRCINVERTER1WORKING_BOOL_TBC                receiveData[456]&bit2
#define TCU_MC2MSR1_BRAKECHOPPER1WORKING_BOOL_TBC                receiveData[456]&bit3
#define TCU_MC2MSR1_MAINCONTACTOR1CLOSED_BOOL_TBC                receiveData[456]&bit4
#define TCU_MC2MSR1_MOTOR1SLIDE_BOOL_TBC                receiveData[456]&bit5
#define TCU_MC2MSR1_MOTOR1SLIP_BOOL_TBC                receiveData[456]&bit6
#define TCU_MC2MSR1_COOLINGFANOK_BOOL_TBC                receiveData[456]&bit7

#define TCU_MC2MSR2_TRCINVERTER1WARNING_BOOL_TBC                receiveData[457]&bit0
#define TCU_MC2MSR2_TRCINVERTER1FAULT_BOOL_TBC                receiveData[457]&bit1
#define TCU_MC2MSR2_TRCINVERTER1WORKING_BOOL_TBC                receiveData[457]&bit2
#define TCU_MC2MSR2_BRAKECHOPPER1WORKING_BOOL_TBC                receiveData[457]&bit3
#define TCU_MC2MSR2_MAINCONTACTOR1CLOSED_BOOL_TBC                receiveData[457]&bit4
#define TCU_MC2MSR2_MOTOR1SLIDE_BOOL_TBC                receiveData[457]&bit5
#define TCU_MC2MSR2_MOTOR1SLIP_BOOL_TBC                receiveData[457]&bit6
#define TCU_MC2MSR2_COOLINGFANOK_BOOL_TBC                receiveData[457]&bit7

#define TCU_MC1MSR1_INPUTVOLTAGE_WORD_TBC               receiveData[438]+receiveData[439]*256
#define TCU_MC1MSR1_NETCURRENT_WORD_TBC               receiveData[440]+receiveData[441]*256
#define TCU_MC1MSR2_INPUTVOLTAGE_WORD_TBC               receiveData[442]+receiveData[443]*256
#define TCU_MC1MSR2_NETCURRENT_WORD_TBC               receiveData[444]+receiveData[445]*256
#define TCU_MC2MSR1_INPUTVOLTAGE_WORD_TBC               receiveData[446]+receiveData[447]*256
#define TCU_MC2MSR1_NETCURRENT_WORD_TBC               receiveData[448]+receiveData[449]*256
#define TCU_MC2MSR2_INPUTVOLTAGE_WORD_TBC               receiveData[450]+receiveData[451]*256
#define TCU_MC2MSR2_NETCURRENT_WORD_TBC               receiveData[452]+receiveData[453]*256

#define MAIN_CURRENTSTATION_BYTE receiveData[460]
#define MAIN_NEXTSTATION_BYTE receiveData[461]

#define PIS_CURRENT_STATION_CODE (unsigned char)receiveData[462]
#define PIS_NEXT_STATION_CODE (unsigned char)receiveData[463]

#define PIS_TRAIN_PREARRIVE (receiveData[464] & bit0)
#define PIS_TRAIN_ARRIVE (receiveData[464] & bit1)
#define PIS_TRAIN_PRERUN (receiveData[464] & bit2)
#define PIS_TRAIN_RUN (receiveData[464] & bit3)

// added by Deng Ran on the 11th of June 2015.
// #define START_STATION (unsigned char)receiveData[138]
// #define END_STATION (unsigned char)receiveData[139]
// #define CURRENT_STATION (unsigned char)receiveData[140]
// #define NEXT_STATION (unsigned char)receiveData[141]


#define TOTAL_MILEAGE_AFTER_POINT (receiveData[466] + receiveData[467] * 256)
#endif // RECEIVEDATA_HE
