...
ROMDATA g_PicRom_Login[] =
{
  ...
  {QSTR("System Login"),            D_FONT(13),           QRect(0,0,640,60),           Qt::black,                      Qt::yellow,                 CONTROL_LABEL,      ID_PICLOGIN_LABEL_TITLE    },
  {""  ,                       D_DEFAULT_FONT,       QRect(115,120,410,  2),      Qt::yellow,                     Qt::transparent,            CONTROL_LINE,       ID_IGNORE    },
  {""  ,                       D_DEFAULT_FONT,       QRect(115,440,410,  2),      Qt::yellow,                     Qt::transparent,            CONTROL_LINE,       ID_IGNORE    },
  {""  ,                       D_DEFAULT_FONT,       QRect(115,120,  2,320),      Qt::yellow,                     Qt::transparent,            CONTROL_LINE,       ID_IGNORE    },
  {""  ,                       D_DEFAULT_FONT,       QRect(525,120,  2,322),      Qt::yellow,                     Qt::transparent,            CONTROL_LINE,       ID_IGNORE    },
  ...
  {QSTR("Driver"),               D_DEFAULT_FONT,       QRect(115, 92, 90, 28),      Qt::yellow,                     Qt::black,                  CONTROL_BUTTON,     ID_PICLOGIN_BUTTON_DRIVER  },
  {QSTR("Maintainer"),            D_DEFAULT_FONT,       QRect(205, 92,120, 28),      Qt::yellow,                     Qt::black,                  CONTROL_BUTTON,     ID_PICLOGIN_BUTTON_MAINTAINER  },
...
void CSysLoginPage::OnDriver()
{
    ...
    this->AddControl(str, QRect(150+35,150, 110, 35), Qt::yellow, D_DEFAULT_FONT, Qt::transparent, ID_PICLOGIN_LABEL_DRIVERCODE, CONTROL_LABEL);
