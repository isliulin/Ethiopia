...
#ifndef CTBCINSTRUCTIONTESTPAGE_H
#define CTBCINSTRUCTIONTESTPAGE_H
...
class CTBCInstructionTestpage : public CPage
{

    DECLEAR_MESSAGE_MAP(CTBCInstructionTestpage)
public:
    CTBCInstructionTestpage();
