...
ROMINFO g_PicRom[] =
{
    ...
    {g_PicRom_AcuStatePageCoupled,      g_AcuStatePageCoupledRomLen     },
    {g_PicRom_TcuStatePageCoupled,      g_TcuStatePageCoupledRomLen     },
    {g_PicRom_BcuStatePageCoupled,      g_BcuStatePageCoupledRomLen     },
    {g_PicRom_HvacStatePageCoupled,      g_HvacStatePageCoupledRomLen     },
{g_PicRom_MyStatePage,      g_MyStatePageRomLen     },
{g_PicRom_EmergencyBroadcastCmd,      g_PicRom_EmergencyBroadcastCmdLen     },
{g_PicRom_InstructionTestTBC,      g_InstructionTestTBCRomLen     },
{g_PicRom_mCurrentStationSet,      g_mCurrentStationSetRomLen     },
